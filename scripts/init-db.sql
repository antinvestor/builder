-- =============================================================================
-- Service Feature - Database Initialization
-- =============================================================================
-- This script creates the initial database schema for the feature service.
-- Run automatically by postgres container on first startup.
-- =============================================================================
...
-- Partition by month for event_log (optional, for high-volume deployments)
...
-- Insert a test execution for verification
INSERT INTO executions (id, repository_url, branch, specification, status, phase)
VALUES (
    'test000000001',
    'https://github.com/example/test-repo.git',
    'main',
    '{"description": "Test feature for verification", "requirements": ["Test requirement"]}',
    'pending',
    'initialization'
) ON CONFLICT (id) DO NOTHING;

-- Grant permissions
GRANT ALL PRIVILEGES ON ALL TABLES IN SCHEMA public TO feature;
GRANT ALL PRIVILEGES ON ALL SEQUENCES IN SCHEMA public TO feature;
