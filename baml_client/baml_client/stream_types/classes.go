...
func (c *AcceptanceCriterion) Decode(holder *cffi.CFFIValueClass, typeMap baml.TypeMap) {
	...
	for _, field := range holder.Fields {
		...
		case "testable":
			c.Testable = baml.Decode(valueHolder).Interface().(*bool)
...
type BehaviorChange struct {
	...
	Change_type      *types.ChangeType `json:"change_type"`
}
...
func (c *BehaviorChange) Decode(holder *cffi.CFFIValueClass, typeMap baml.TypeMap) {
	...
	for _, field := range holder.Fields {
		...
		case "change_type":
			c.Change_type = baml.Decode(valueHolder).Interface().(*types.ChangeType)
...
func (c *CodeConstraints) Decode(holder *cffi.CFFIValueClass, typeMap baml.TypeMap) {
	...
	for _, field := range holder.Fields {
		...
		case "max_file_size_lines":
			c.Max_file_size_lines = baml.Decode(valueHolder).Interface().(*int64)

		case "preserve_formatting":
			c.Preserve_formatting = baml.Decode(valueHolder).Interface().(*bool)

		case "maintain_compatibility":
			c.Maintain_compatibility = baml.Decode(valueHolder).Interface().(*bool)
...
func (c *CodeQualityMetrics) Decode(holder *cffi.CFFIValueClass, typeMap baml.TypeMap) {
	...
	for _, field := range holder.Fields {
		...
		case "cyclomatic_complexity":
			c.Cyclomatic_complexity = baml.Decode(valueHolder).Interface().(*float64)

		case "cognitive_complexity":
			c.Cognitive_complexity = baml.Decode(valueHolder).Interface().(*float64)

		case "lines_of_code":
			c.Lines_of_code = baml.Decode(valueHolder).Interface().(*int64)

		case "lines_of_comments":
			c.Lines_of_comments = baml.Decode(valueHolder).Interface().(*int64)

		case "comment_ratio":
			c.Comment_ratio = baml.Decode(valueHolder).Interface().(*float64)

		case "duplication_percent":
			c.Duplication_percent = baml.Decode(valueHolder).Interface().(*float64)
...
type CommitMessage struct {
	...
	Type    *types.CommitType `json:"type"`
}
...
func (c *CommitMessage) Decode(holder *cffi.CFFIValueClass, typeMap baml.TypeMap) {
	...
	for _, field := range holder.Fields {
		...
		case "type":
			c.Type = baml.Decode(valueHolder).Interface().(*types.CommitType)
...
type ComplexityAssessment struct {
	Level           *types.ComplexityLevel `json:"level"`
...
func (c *ComplexityAssessment) Decode(holder *cffi.CFFIValueClass, typeMap baml.TypeMap) {
	...
	for _, field := range holder.Fields {
		...
		case "level":
			c.Level = baml.Decode(valueHolder).Interface().(*types.ComplexityLevel)

		case "estimated_steps":
			c.Estimated_steps = baml.Decode(valueHolder).Interface().(*int64)

		case "estimated_files":
			c.Estimated_files = baml.Decode(valueHolder).Interface().(*int64)
...
func (c *ComponentReference) Decode(holder *cffi.CFFIValueClass, typeMap baml.TypeMap) {
	...
	for _, field := range holder.Fields {
		...
		case "type":
			c.Type = baml.Decode(valueHolder).Interface().(*types.ComponentType)
...
type DependencyEdge struct {
	...
	Edge_type *types.EdgeType `json:"edge_type"`
}
...
func (c *DependencyEdge) Decode(holder *cffi.CFFIValueClass, typeMap baml.TypeMap) {
	...
	for _, field := range holder.Fields {
		...
		case "edge_type":
			c.Edge_type = baml.Decode(valueHolder).Interface().(*types.EdgeType)
...
type DependencyNode struct {
	...
	Path      *string         `json:"path"`
	Symbol    *string         `json:"symbol"`
	Node_type *types.NodeType `json:"node_type"`
}
...
func (c *DependencyNode) Decode(holder *cffi.CFFIValueClass, typeMap baml.TypeMap) {
	...
	for _, field := range holder.Fields {
		...
		case "node_type":
			c.Node_type = baml.Decode(valueHolder).Interface().(*types.NodeType)
...
type FeatureSpecification struct {
	...
	Category            *types.FeatureCategory `json:"category"`
}
...
func (c *FeatureSpecification) Decode(holder *cffi.CFFIValueClass, typeMap baml.TypeMap) {
	...
	for _, field := range holder.Fields {
		...
		case "category":
			c.Category = baml.Decode(valueHolder).Interface().(*types.FeatureCategory)
...
type FileChange struct {
	File_path     *string           `json:"file_path"`
	Action        *types.FileAction `json:"action"`
...
func (c *FileChange) Decode(holder *cffi.CFFIValueClass, typeMap baml.TypeMap) {
	...
	for _, field := range holder.Fields {
		...
		case "action":
			c.Action = baml.Decode(valueHolder).Interface().(*types.FileAction)
...
type FileImpact struct {
	File_path        *string           `json:"file_path"`
	Impact_type      *types.ImpactType `json:"impact_type"`
...
func (c *FileImpact) Decode(holder *cffi.CFFIValueClass, typeMap baml.TypeMap) {
	...
	for _, field := range holder.Fields {
		...
		case "impact_type":
			c.Impact_type = baml.Decode(valueHolder).Interface().(*types.ImpactType)
...
func (c *IterationContext) Decode(holder *cffi.CFFIValueClass, typeMap baml.TypeMap) {
	...
	for _, field := range holder.Fields {
		...
		case "previous_attempts":
			c.Previous_attempts = baml.Decode(valueHolder).Interface().(*int64)
...
type IterationPlan struct {
	Strategy           *types.IterationStrategy `json:"strategy"`
...
func (c *IterationPlan) Decode(holder *cffi.CFFIValueClass, typeMap baml.TypeMap) {
	...
	for _, field := range holder.Fields {
		...
		case "strategy":
			c.Strategy = baml.Decode(valueHolder).Interface().(*types.IterationStrategy)
...
func (c *PlanMetrics) Decode(holder *cffi.CFFIValueClass, typeMap baml.TypeMap) {
	...
	for _, field := range holder.Fields {
		...
		case "total_steps":
			c.Total_steps = baml.Decode(valueHolder).Interface().(*int64)

		case "estimated_tokens":
			c.Estimated_tokens = baml.Decode(valueHolder).Interface().(*int64)

		case "estimated_files_total":
			c.Estimated_files_total = baml.Decode(valueHolder).Interface().(*int64)

		case "estimated_new_files":
			c.Estimated_new_files = baml.Decode(valueHolder).Interface().(*int64)

		case "estimated_modified":
			c.Estimated_modified = baml.Decode(valueHolder).Interface().(*int64)

		case "estimated_deleted":
			c.Estimated_deleted = baml.Decode(valueHolder).Interface().(*int64)
...
func (c *PlanStep) Decode(holder *cffi.CFFIValueClass, typeMap baml.TypeMap) {
	...
	for _, field := range holder.Fields {
		...
		case "step_number":
			c.Step_number = baml.Decode(valueHolder).Interface().(*int64)
...
type ReviewAssessment struct {
	...
	Recommendation *types.ReviewRecommendation `json:"recommendation"`
	Summary        *string                     `json:"summary"`
...
func (c *ReviewAssessment) Decode(holder *cffi.CFFIValueClass, typeMap baml.TypeMap) {
	...
	for _, field := range holder.Fields {
		...
		case "overall_score":
			c.Overall_score = baml.Decode(valueHolder).Interface().(*int64)

		case "recommendation":
			c.Recommendation = baml.Decode(valueHolder).Interface().(*types.ReviewRecommendation)
...
type ReviewIssue struct {
	Id           *string                    `json:"id"`
	Type         *types.ReviewIssueType     `json:"type"`
	Severity     *types.ReviewIssueSeverity `json:"severity"`
	File_path    *string                    `json:"file_path"`
...
func (c *ReviewIssue) Decode(holder *cffi.CFFIValueClass, typeMap baml.TypeMap) {
	...
	for _, field := range holder.Fields {
		...
		case "type":
			c.Type = baml.Decode(valueHolder).Interface().(*types.ReviewIssueType)

		case "severity":
			c.Severity = baml.Decode(valueHolder).Interface().(*types.ReviewIssueSeverity)

		case "file_path":
			c.File_path = baml.Decode(valueHolder).Interface().(*string)

		case "line_start":
			c.Line_start = baml.Decode(valueHolder).Interface().(*int64)

		case "line_end":
			c.Line_end = baml.Decode(valueHolder).Interface().(*int64)
...
func (c *Risk) Decode(holder *cffi.CFFIValueClass, typeMap baml.TypeMap) {
	...
	for _, field := range holder.Fields {
		...
		case "level":
			c.Level = baml.Decode(valueHolder).Interface().(*types.RiskLevel)
...
type StepDependency struct {
	...
	Dependency_type *types.DependencyKind `json:"dependency_type"`
	Reason          *string               `json:"reason"`
}
...
func (c *StepDependency) Decode(holder *cffi.CFFIValueClass, typeMap baml.TypeMap) {
	...
	for _, field := range holder.Fields {
		...
		case "from_step":
			c.From_step = baml.Decode(valueHolder).Interface().(*int64)

		case "to_step":
			c.To_step = baml.Decode(valueHolder).Interface().(*int64)

		case "dependency_type":
			c.Dependency_type = baml.Decode(valueHolder).Interface().(*types.DependencyKind)
...
func (c *StepVerification) Decode(holder *cffi.CFFIValueClass, typeMap baml.TypeMap) {
	...
	for _, field := range holder.Fields {
		...
		case "method":
			c.Method = baml.Decode(valueHolder).Interface().(*types.VerificationMethod)
...
type TargetFile struct {
	Path        *string               `json:"path"`
	Action      *types.FileAction     `json:"action"`
	Change_type *types.FileChangeType `json:"change_type"`
	Reason      *string               `json:"reason"`
}
...
func (c *TargetFile) Decode(holder *cffi.CFFIValueClass, typeMap baml.TypeMap) {
	...
	for _, field := range holder.Fields {
		...
		case "change_type":
			c.Change_type = baml.Decode(valueHolder).Interface().(*types.FileChangeType)
...
type TestCase struct {
	Name            *string         `json:"name"`
	Description     *string         `json:"description"`
	Test_type       *types.TestType `json:"test_type"`
...
func (c *TestCase) Decode(holder *cffi.CFFIValueClass, typeMap baml.TypeMap) {
	...
	for _, field := range holder.Fields {
		...
		case "test_type":
			c.Test_type = baml.Decode(valueHolder).Interface().(*types.TestType)
...
func (c *TestGenerationRequest) Decode(holder *cffi.CFFIValueClass, typeMap baml.TypeMap) {
	...
	for _, field := range holder.Fields {
		...
		case "coverage_target":
			c.Coverage_target = baml.Decode(valueHolder).Interface().(*float64)
...
func (c *TestGenerationResult) Decode(holder *cffi.CFFIValueClass, typeMap baml.TypeMap) {
	...
	for _, field := range holder.Fields {
		...
		case "coverage_estimate":
			c.Coverage_estimate = baml.Decode(valueHolder).Interface().(*float64)
